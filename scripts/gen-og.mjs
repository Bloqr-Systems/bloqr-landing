...
const bars = [
  ...
  { w: 260, y: 236, opacity: 0.20, cyan: true },
...
let barSvg = '';
for (const b of bars) {
  const fill   = b.accent ? '#FF5500' : b.cyan ? '#00D4FF' : 'white';
  const rx     = 6;
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="188" y="120"
    font-family="system-ui, -apple-system, 'Helvetica Neue', sans-serif"
    font-size="10" font-weight="400" fill="#00D4FF" letter-spacing="3">HYGIENE.</text>
  <text x="252" y="120"
    font-family="system-ui, -apple-system, 'Helvetica Neue', sans-serif"
    font-size="10" font-weight="400" fill="rgba(255,255,255,0.45)" letter-spacing="3"> AUTOMATED.</text>

  <!-- Main headline -->
  <text x="80" y="266"
    font-family="system-ui, -apple-system, 'Helvetica Neue', sans-serif"
    font-size="62" font-weight="800" fill="white" letter-spacing="-1.5">Internet</text>
  <text x="80" y="340"
    font-family="system-ui, -apple-system, 'Helvetica Neue', sans-serif"
    font-size="62" font-weight="800" fill="#FF5500" letter-spacing="-1.5">Hygiene.</text>

  <!-- Subline -->
  <text x="80" y="390"
    font-family="system-ui, -apple-system, 'Helvetica Neue', sans-serif"
    font-size="19" font-weight="400" fill="rgba(255,255,255,0.5)" letter-spacing="0">Automated.</text>
