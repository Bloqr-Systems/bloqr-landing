    ...
    <section style={{ position: 'relative', padding: '72px 0 80px', textAlign: 'center', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', position: 'relative' }}>
        ...
        <div style={{
          ...
          <span><strong style={{ color: 'var(--fg-1)' }}>Bring your own vendor.</strong> Happy with your current privacy setup? Keep it. Bloqr works alongside whatever you're already running. Starting fresh? We've got you covered. Bring your own. Or use ours.</span>
        </div>
